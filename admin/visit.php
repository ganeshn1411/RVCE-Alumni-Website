...
<div class="mp-level" style="background-color:#FFFFFF; style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);" >
									...
									<ul>
<li class="icon" ><a class="icon " href="achievements" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Insert</a></li>
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Delete</a></li>
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Update</a></li>	
									</ul>
								</div>
...
<br>		
			<div>
			<label for="date">Date of Visit<p class="help-inline">*</p></label>
			<input id="date" type="date" name="date" required>
			
		</div>
		<br>
		<div>
			<label for="address">Purpose of Visit<p class="help-inline">*</p></label>
...
$sql="INSERT INTO visit(USN,date, purpose) VALUES ('$_POST[USN]','$_POST[date]','$_POST[purpose]')";
