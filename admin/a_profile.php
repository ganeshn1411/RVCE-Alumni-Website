...
<li class="icon" ><a class="icon " href="delstudent.php" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px">Delete</a></li>
...
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Update</a></li>	
	...
	<div class="scroller"><!-- this is for emulating position fixed of the nav -->
					<div class="scroller-inner">
						<!-- Top Navigation -->
						<div class="codrops-top clearfix" style="height:60px; background-color:#FFFFFF; z-index=10">
		...
		<br>
		<img src="../images/download.jpg" style="float:left; padding: 20px;"/>
		<p>You have the following privilages<br>
		<ul>
		...
		Do explore all the feautures
						...
						<div class="content clearfix" >
							<div class="block block-40 clearfix" >
								<p><a href="#" id="trigger" class="menu-trigger" style="color:#000000;position:absolute;top:80px;left:50px;"></a></p>
								</div>
							</div>
					</div><!-- /scroller-inner -->
				</div><!-- /scroller -->
