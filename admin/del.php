...
$sql="DELETE FROM member(USN,f_name,m_name,l_name,YOA,YOG,Branch) VALUES ('$_POST[usn]','$_POST[f_name]','$_POST[m_name]','$_POST[l_name]','$_POST[YOA]','$_POST[YOG]','$_POST[branch]')";
if (!mysql_query($sql))
  {
...
<li class="icon" ><a class="icon " href="delstu.php" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Delete</a></li>
