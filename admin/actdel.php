...
<form method="post" onsubmit="a_profile.php;">
<body>
		<div class="container">
			<!-- Push Wrapper -->
...
<li class="icon" ><a class="icon " href="actdel.php" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Delete</a></li>
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Update</a></li>	
									</ul>
								</div>
							</li>
...
<li class="icon" ><a class="icon " href="semdel.php" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Delete</a></li>
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Update</a></li>	
									</ul>
								</div>
							</li>
...
<li class="icon" ><a class="icon " href="#" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:18px;">Update</a></li>	
								...
								<a class="icon" href="#" style="color:rgba(0,0,0,0.8);
text-shadow: 0 0 1px rgba(0,0,0,0.1);font-size:20px;">Achievements</a>
<div class="mp-level" style="background-color:#FFFFFF; style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);" >
									<h2 class="icon" style="color:rgba(0,0,0,0.8); text-shadow: 0 0 1px rgba(0,0,0,0.1);">Achievements</h2>
									<ul>
...
$aname=$_POST['a_name'];
$sql="DELETE FROM activity WHERE A_Name='$aname'";
