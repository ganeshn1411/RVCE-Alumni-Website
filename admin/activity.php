...
$sql="INSERT INTO activity(A_Name,Date,Type,Location,Start_time,End_time,Purpose,Agenda) VALUES ('$_POST[a_name]','$_POST[Date]','$_POST[type]','$_POST[location]','$_POST[s_date]','$_POST[e_date]','$_POST[purpose]','$_POST[agenda]')";
