...
<br>
<form method="post" action="contribution_display.php">
<div class="container2" class="footer" style="float:right;width:250px;position:fixed;left:1080px;top:40px;">
<div class="footer">

<a href="fund_details.php" class="register" style="text-decoration:none;">Want to contribute?<br> Click here for details</a>
</div>
</div>
<div class='container1'>
<h1>Contributions by the Alumni</h1>
</div>	
<?php 
require_once('db/connect.php');
$query1="select * from funds,member where funds.USN=member.USN order by Date";
$result1=mysqli_query($db,$query1) or die("cannot retrieve");
...
echo "<br><p class='help1-inline'>Contribution Date   :    </p><p class='help1-inline'>".$row1['date']." </p>"."<br>"."<p class='help1-inline'>Purpose   :    </p><p class='help1-inline'>".$row1['purpose']." </p>"."<br>".
"<p class='help1-inline'>Amount Donated :    </p><p class='help1-inline'>".$row1['amount']." </p>"."<br></div>";
}?>
