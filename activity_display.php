...
<?php 
require_once('db/connect.php');
$query1="select * from activity order by Date";
$result1=mysqli_query($db,$query1) or die("cannot retrieve");

while($row1=mysqli_fetch_array($result1))
{echo "<div class='container1'> <h2>".$row1['A_Name']."</h2>";
echo "<p class='help1-inline'>Activity Date   :    </p><p class='help1-inline'>".$row1['Date']." </p>"."<br>"."<p class='help1-inline'>Activity Location   :    </p><p class='help1-inline'>".$row1['Location']." </p>"."<br>".
"<p class='help1-inline'>Registration Start Date  :    </p><p class='help1-inline'>".$row1['Start_time']." </p>"."<br>"."<p class='help1-inline'>Registration Deadline   :    </p><p class='help1-inline'>".$row1['End_time']." </p>"."<br>"."<p class='help1-inline'>Purpose   :    </p><p class='help1-inline'>".$row1['Purpose']." </p>"."<br>"."<p class='help1-inline'>Agenda   :    </p><p class='help1-inline'>".$row1['Agenda']." </p>"."<br>"."</div>";
}?>
