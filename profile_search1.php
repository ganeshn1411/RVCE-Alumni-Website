...
if(!$row1)
{
echo "<script>alert('The name you entered does not exist. Please correct your input');
...
<h1>Personal Info</h1>
		...
		<div>
		<img style="float:right;no-repeat center center; width: 170px; height: 135px; 
			-webkit-border-radius: 1em;
			-moz-border-radius: 1em;
			border-radius: 1em; position:relative;top:-40px;left:-100px;" src="<?php if(!empty($pic)) echo $pic; ?>" />	
		</div>
		<br>
		<div>
